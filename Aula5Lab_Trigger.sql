...
DELIMITER $
CREATE TRIGGER tg_updatebkp_funcionarios
BEFORE UPDATE
ON funcionarios
FOR EACH ROW
BEGIN
	INSERT INTO bkpupdate
    VALUES (NOW(), OLD.id, OLD.nome, OLD.telefone, OLD.email, OLD.data_nascimento, OLD.rua,
    OLD.bairro, OLD.cidade, OLD.estado, OLD.estado_sigla, OLD.cargo, OLD.salario );
END
$
DELIMITER ;
...
UPDATE funcionarios SET email = 'larinha007@gmail.com', telefone = '0800 156 5616' WHERE id = 40;
